...
## ⬇️ Create a vector store (FAISS) from sample texts using OpenAI embeddings
...
# ⬇️ 用向量存储vector store创建一个索引Retriever. Create an index retriever with a vector store.
retriever = (
