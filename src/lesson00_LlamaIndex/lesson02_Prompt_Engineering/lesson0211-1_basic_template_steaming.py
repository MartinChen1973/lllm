...
# Stream the chain responses
for params in [
    {"grade" : "小学三年级", "subject": "雪花", "type":"记叙文", "size":"500"},
    {"grade" : "初中三年级", "subject": "春节", "type":"说明文", "size":"600"},
    {"grade" : "高中三年级", "subject": "是否应该废除死刑", "type":"议论文", "size":"800"}
]:
