...
prompt_summarize = ChatPromptTemplate.from_messages([
    ("system", "请检查以下输入的文字长度，如果超出了50个字，请将其总结为50个汉字。文字内容：{input}")
])
# ---------------------------------------------
...
# chain = prompt_answer | model | output_parser 
chain = prompt_answer | model | output_parser | prompt_summarize | model | output_parser

# 文学问题
input = """请用白话文50字总结以下诗歌内容，尤其是诗人自身的情感：\n
